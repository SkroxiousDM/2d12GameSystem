...
* **Cost:** 4 (causes Stun on Complication)
* **Duration:** Instant  
...
After the oracle casts this spell, the target gains the scar **The Fates Must Be Balanced** until the oracle rolls a complication on a skill test. While this scar persists, the target's complication range on all skill tests increases by \+1.
...
**Spell Effect:** The spell grants the oracle fragmentary visions of future events. Once at any point during the spell's duration, the oracle may declare that they foresaw a critical moment and gain Advantage on a single skill test made against an immediate threat or opportunity. Resolving the test ends the spell.

**Success Levels:**

* For 2 Success Levels, the spell does not end after the foreseen test is resolved, and the oracle may use the Advantage a second time before the duration expires.
* For 2 Success Levels, the oracle receives a vision of another character's future and may grant the foreseen Advantage to that character instead.
...
* **Skill:** Observation  
* **Difficulty:** Difficult  
* **Cost:** 3 (Piercing 1 on Complication)
* **Duration:** One hour  
* **Category:** Blessing spell

**Spell Effect:** The oracle targets themselves or one allied character within Close range. Targeted characters reduce the difficulty of vision-based skill tests by 2, ignore any difficulty or complication range increases caused by darkness, and may attempt skill tests that would otherwise be impossible due to darkness.
