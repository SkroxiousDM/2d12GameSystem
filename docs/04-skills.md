...
Each skill includes specializations that reflect focused expertise.

### Skill Specializations

A specialization is a narrow focus within a skill. For example, a character trained in Manipulation might specialize in Deception, or a character with Academia might specialize in Philosophy.

* A character gains two specializations at character creation.  
* A specialization must be tied to a skill in which the character is trained.  
* A character cannot take the same specialization more than once.  
* When a specialization applies, it grants Advantage to the related check.
...
| Linguistics | The study of languages in their current and historical forms, including dead languages and patterns of linguistic change. A character with this specialization may know up to three additional languages. (Casting spells requires a Spellcaster trait.) |
| Philosophy | The study of fundamental concepts and truths, influential philosophical traditions, and the major thinkers who shaped them. |
| Religion | The study of the gods, their manifestations, and the practices, traditions, and creatures associated with them. (Casting spells requires a Spellcaster trait.) |
...
| Running | Short-distance sprinting and long-distance endurance running. |
| Swimming | Unaided swimming and diving. |
...
| Unarmed | Striking and grappling techniques ranging from formal pankration to improvised brawling. |
| War Magic | Casting direct, damaging spells in the heat of combat. (Requires a Spellcaster trait.) |
...
| Intimidation | Inspiring fear or doubt, or leveraging a target's vulnerabilities against them. |
| Invocation | Esoteric methods of communicating with unnatural entities. (Requires a Spellcaster trait.) |
| Negotiation | Reaching mutually acceptable agreements through conversation, including barter and payment. |
| Rhetoric | Using language in public speaking or formal debate to inform, persuade, or motivate an audience. |
...
| Smell and Taste | Detecting and identifying scents and flavors. Useful for physicians, poisoners, food tasters, and cooks. |
| Scrutinize | Examining a location or object to reconstruct events or uncover non-obvious information. |
...
| Hunting | Stalking, catching, and killing animal prey, including preparing game. |
| Mysticism | Practices used in the wilds to petition natural powers or spirits for protection. (Requires a Spellcaster trait.) |
| Navigation | Maintaining direction, planning routes, and managing the physical demands of overland travel. |
| Tracking | Following and interpreting tracks, and determining details such as number, direction, speed, and condition of those tracked. |
| Woodcraft | Wilderness living skills, including constructing shelter and camp facilities from natural materials. |
...
| Navy | Naval strategy and tactics from river engagements to full fleet actions. |
| Omen Reading | Interpreting signs in the natural world as guides for future action. (Requires a Spellcaster trait.) |
| Scouting | Organizing teams for ambushes, reconnaissance, and covert operations in hostile territory. |
