...
This powerful runic ward is associated with Algiz, the rune of protection, and draws on the power of Baldr, most beloved of all the Æsir. The rune cloaks its targets in mystical armour, granting them near-immunity from Stress: accurate shots narrowly miss their mark, damage dissipates, and the influence of malign forces greatly diminishes under its protective aegis.
...
**Spell Effect:** The spellcaster inflicts power \+2 mental Stress with the Stun effect on all enemies within Close range.

**Flawed:** A flawed version of this spell affects all creatures within range, not just enemies.

**Success Levels:**

* For 2 Success Levels, add the Persistent 6 effect to the Stress.  
* For 2 Success Levels, add the Snare effect to the Stress.
...
**Spell Effect:** The spell targets a single enemy or object within Medium range and inflicts power \+2 physical Stress with the Area effect.
...
* For 2 Success Levels, each affected allied target inflicts \+2 Stress on all melee attacks they make.  
