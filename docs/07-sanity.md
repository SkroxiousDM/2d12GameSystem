...
Unless otherwise noted, any madness a character develops is transient. If a character must roll on the Madness table while already afflicted with a transient madness, the new madness is short-term. If they are suffering from a short-term madness when they must roll again, the newly developed psychosis is long-term.

- **Transient** madness persists until the character completes the encounter that caused it. A few quiet moments of self-reassurance are sufficient to quell it — a Breather is all that is needed.
- **Short-term** madness persists until the character takes a short rest, drawing on the support of companions and rebuilding their mental defences.
- **Long-term** madness persists until the character spends downtime to address the condition — or, if downtime is not in use, until the current adventure or quest is complete. A week of rest and support is required to quell a long-term madness.
- **Indefinite** madness is permanent unless cured by exceptional means.

---

## Manifesting Madness

The acute manifestation of a character's lunacy should be thematically congruous with the situation that caused the initial Horror check. That said, the link between the symptoms and the triggering event may not be immediately obvious. This is an opportunity for the player and the GM to be creative and develop the character's idiosyncrasies.

The tables below provide a range of options for the GM and player to explore. When relevant, the GM should roll or choose an appropriate entry.
...
| 6 | **Panic** — Panic permeates every action the character takes. | The character gains +2 on Initiative and suffers −2 on all tests against fear effects. |
...
| 17 | **Catatonic** — The character retreats into their mind, waiting for someone to give them direction. | The character will not act without external direction for 1d4 rounds. All tests against charm effects and Manipulation-based tests are made at Disadvantage. Allies may use their reaction to give basic directions. |
...
The effects of long-term madness persist until the character has completely recovered — mentally and physically — from the stresses of adventuring, requiring at least a week's break. Indefinite madness cannot be cured except through exceptional intervention.

After each long rest, a character suffering from long-term or indefinite madness must make a **Resilience (Discipline) check** to suppress the effects until their next long rest. The initial difficulty is Challenging (+0). With each successful check, the difficulty increases by one tier (toward Hard, then Very Hard), until the madness eventually manifests and the process resets. If the character fails their check, the madness manifests as a persistent effect and may also trigger an acute attack during high-stress situations — including combat and, at the GM's discretion, tense social encounters. To control themselves during a high-stress situation the character must make a **Resilience (Discipline) check** (Hard (−4)), applying their Insight modifier. On a failure, they suffer the Acute effect of their madness.
...
| 4 | **Nervous Energy** — The character is a frenetic, chattering bundle of energy at all times. | *Persistent:* +1 zone of movement per turn. The character makes all tests against Fatigue at Disadvantage. |
| 5 | **Hypervigilance** — The character is startled by the smallest sound and is constantly reminded of past trauma. | *Persistent:* +1 to Initiative; −1 on tests against fear effects. |
| 6 | **Anxiety** — The character's thoughts are filled with dread and foreboding. | *Persistent:* −1 on tests against fear effects. |
| 7 | **Panic Attacks** — The character is overwhelmed with helplessness and loses all hope. | *Persistent:* −2 on Initiative and on tests against fear effects. |
...
| 12 | **Somnambulism** — The character sleepwalks during long rests. | *Persistent:* During long rests the character sleepwalks, possibly wandering from camp entirely. They must make a Routine (+20) Resilience (Fortitude) test or gain only the benefits of a short rest. |
| 13 | **Bipolar Episodes** — The character's demeanour shifts between mania and depression. | Roll 1d2 when this manifests. *1 — Mania:* −2 on tests requiring patience or fine motor skills; +2 on Manipulation (Charm) and Performance tests. *2 — Depression:* −2 on all Charisma-based tests; +2 on Agility (Stealth) tests at half speed or slower. |
...
| 16 | **Dissociative Identity** — An alternative personality surfaces. | *Persistent:* The character's personality changes significantly. Skills and abilities are unaffected, but disposition and values may shift and reactions to situations should differ notably. |
...
| 21 | **Night Terrors** — The character screams throughout the night, reliving the horrors they have experienced. | *Persistent:* Characters resting nearby must make a Routine (+20) Resilience (Fortitude) test or gain only the benefits of a short rest. If woken, the character with night terrors also gains only a short rest. |
...
| 23 | **Catatonia** — The character retreats inward, waiting for external direction. | *Persistent:* −2 to Insight and Initiative. *Acute:* Will not act without external direction for 1d4 rounds; Disadvantage on all tests against charm and Manipulation-based tests. |
